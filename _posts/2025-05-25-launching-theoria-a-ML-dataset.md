...
The [main repository](https://github.com/theoria-dataset/theoria-dataset) is on GitHub, and you can see an example of a raw entry here, the [Special relativity transformations](https://github.com/theoria-dataset/theoria-dataset/blob/main/entries/special_relativity_transformations.json). We also have a comprehensive [contributing guide](https://github.com/theoria-dataset/theoria-dataset/blob/main/CONTRIBUTING.md).
