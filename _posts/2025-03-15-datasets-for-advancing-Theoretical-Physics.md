...
## Theoretical Physics (Knowledge & Simulation)
...
| **Lattice QCD Configurations**                    | Quantum Field Theory (lattice QCD) – gauge field samples, correlation functions                                                                                                                                                                                                | Numeric (lattice data)             | Frontier research  | Partially open ([several](https://www.jldg.org/ildg-data/) [research](https://hpc.desy.de/ildg/) groups)                                                    |
